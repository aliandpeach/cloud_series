...
import com.yk.message.api.factory.ConsumerFactory;
...
public class ConsumerTest
{
    ...
    public void test()
    {
        ...
        IConsumer<String, String> consumer = ConsumerFactory.getInstance().getConsumer(params);
        consumer.subscribe(Collections.singletonList("testz"));
